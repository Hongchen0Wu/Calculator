    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //如果equal_flag=1，表示要输入新的数学表达式，清空当前数学表达式并设置flag=0
                //equal_flag=1,说明当前数学表达式计算完毕
                if (equal_flag == 1) {
                    mathCurrent = "";
                    equal_flag = 0;
                }
        ...
        if (isLand()) {//横屏
            btnBracket.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mathCurrent.length() == 0) {                                //1.math为空，+(
                        mathCurrent += "(";
                        ...
                        mathCurrent += "(";
                    } else if (isNum(mathCurrent.charAt(mathCurrent.length() - 1))      //3.math最后一个字符是num, π, e
                            || mathCurrent.charAt(mathCurrent.length() - 1) == 'π'
                            || mathCurrent.charAt(mathCurrent.length() - 1) == 'e') {
                        if (!hasStartBracket(mathCurrent))                               //3.1 没有(, 加 *(
                            mathCurrent += "*(";
                        else                                                        //3.2 已有(, 加 )
                            mathCurrent += ")";
                    } else if (mathCurrent.charAt(mathCurrent.length() - 1) == ')') {   //4.math最后一个字符是)，说明用户是在补全右括号，+)
                        mathCurrent += ")";
                    }
                    etCurrent.setText(mathCurrent);
                }
